            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 col-xl-4">
                        <div class="card">
                            <div class="card-header">Average Readings this Month
                                <div class="card-action">
                                    <div class="dropdown">
                                        <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret"
                                            data-toggle="dropdown">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center">
                                    <tbody>
                                        <tr>
                                            <td><i class="fa fa-circle text-white mr-2"></i>Temperature</td>
                                            <td>30.5 °C</td>
                                            {{-- <td>+55%</td> --}}
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-circle text-light-1 mr-2"></i>pH Level</td>
                                            <td>602 pH</td>
                                            {{-- <td>+25%</td> --}}
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-circle text-light-2 mr-2"></i>Dissolved Oxygen</td>
                                            <td>30 O2</td>
                                            {{-- <td>+15%</td> --}}
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-circle text-light-3 mr-2"></i>Salanity</td>
                                            <td>54 ‰</td>
                                            {{-- <td>+5%</td> --}}
                                        </tr>
                                    </tbody>
