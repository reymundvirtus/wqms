...
Route::middleware(['auth'])->group(function() {
    ...
    Route::post('/calendar/update/{id}', [ReminderController::class, 'update']); //? this will update in calendar itself
    Route::post('/calendar/delete/{id}', [ReminderController::class, 'delete']); //? this will delete in calendar itself
